...
| T5 | (ecosystem) | Walbolge, Malbolge-Engine, malbolge-oracle, Autobolge, meowbolge, Malbolge-Translator (sibling repos in the same workspace) | Independent interpreters, generators, decompiler | exact dates not re-verified in this dossier | The independent-observers idea, later reused as Antivirusbolge backends |
